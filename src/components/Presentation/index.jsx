    ...
    return (
        <div className='w-screen h-screen flex flex-col items-center justify-center' style={containerStyle}>
            ...
            <div className='flex flex-col items-center mb-12'>
                <h1 className='text-8xl font-bold mb-2' style={{ fontFamily: 'Times New Roman, serif' }}>Hokaiz Media</h1>
                <p className='text-xl'>Paixão pela velocidade, perfeição nos detalhes.</p>
            </div>
